...
acneIng = ["witch", "AVOCADO", "AMOXICILLIN", "AZELAIC", "Niacinamide", "alpha-hydroxy acid", "APPLE CIDER VINEGAR", 
           "BENZOYL PEROXIDE", "CUMIN", "BENTONITE", "Cannabidiol", "citric", "lactic", "malic", "retinol", 
           "retinal", "retinyl", "salicylic", "HYDROGEN PEROXIDE", "HEMP", "CORTISONE", "HONEY", 
           "KAOLIN", "MAGNESIUM", "MANDELIC", "ZINC", "PROPOLIS", "LACTOCOCCUS", "Centella Asiatica", 
           "SULFUR", "SUCCINIC", "TRETINOIN", "TURMERIC", "Damascena", "Beeswax", "vitamin a"]
...
# data.to_json('cosmetics.json', orient='records')
# data.to_json('train_file.json', orient='records')
