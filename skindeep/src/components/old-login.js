    ...
    if (authMode === "signin") {
      return (
        <div className="Auth-form-container">
          <div>
                <div id='logbtn'>
                    <button className='flex flex-row px-7 py-5 border-2 text-white tracking-wide justify-between items-center h-full rounded-lg bg-blue-600 hover:bg-pink-600' onClick={setModalOpen}><img className='h-10 w-10 xs:h-4 xs:w-4'src={heart} /><span className='font-Archivo px-3 xs:px-0'> Login </span><img className='h-10 w-10 xs:h-4 xs:w-4'src={heart} /></button>
                </div>
             </div>
